...
// AssignOnCallRole assigns the on-call role to the on-call managed group in Boundary
...
// RevokeOnCallRole revokes the on-call role from the on-call managed group in Boundary
